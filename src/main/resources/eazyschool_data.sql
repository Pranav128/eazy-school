...
INSERT INTO `holidays` (`day`,`reason`,`type`,`created_at`, `created_by`)
 VALUES (' May 1 ','Labor Day','FEDERAL',CURDATE(),'DBA');
...
INSERT INTO `person` (`name`,`email`,`mobile_number`,`pwd`,`role_id`,`created_at`, `created_by`)
  VALUES ('Admin','admin@eazyschool.com','3443434343','$2a$12$2VUsgPLfv65z3wCiM/2/qekM8NIleD6ONBaL3BV/k76.mwWRni5.O', 1 ,CURDATE(),'DBA');
